...
public class EnterFood {
   ...
   public void showButtonDemo(){
		...
		headerLabel.setText("Resturant Management System");
      ...
      okButton.addActionListener(new ActionListener() {
         public void actionPerformed(ActionEvent e) {
            ...
            try{
                pst = con.mkDataBase().prepareStatement("insert into resturantmanagement.food(f_name,f_prize,f_quantity) values (?,?,?)");
